...
materials_file.cross_sections = '../../OpenMCLib/cross_sections.xml'
...
#  Non-movable    Movable    Uppler B   ARO       RE2=70mm    What's in ARO    What's in 70mm
#  pz_CR_HEA      -          219.405    -         -           SHA_HEA          SHA_HEA
#  pz_CR_HCO      -          206.451    -         -           SHA_HCO          SHA_HCO
#  pz_CR_TRS      -          198.518    -         -           SHA_TRS          SHA_TRS
#  pz_CR_UPL      -          197.514    -         -           SHA_UPL          SHA_UPL
#  pz_CR_WRA      -          130.839    -         -           UCO_UPL          UCO_UPL
#  -              pz_CR_UCO  68.32      193.183   150.183     PLE_UPL          PLE_UPL
#  -              pz_CR_PLE  61.794     186.657   143.657     ABS_UPL          ABS_UPL
#  -              pz_CR_ABS  58.681     183.544   140.544     LCO_UPL          ABS_WRA
#  -              pz_CR_LCO  7.631      132.494   89.494      LCO_WRA          LCO_WRA
#  -              pz_CR_BAF  4.217      129.08    86.08       BAF_WRA          BAF_WRA
#  -              pz_CR_BOT  0          124.863   81.863      BOT_WRA          BOT_WRA
#  pz_CR_SHL      -          65.872     -         -           -                -
...
pz_CR22_UCO_UPL = openmc.ZPlane( z0= 150.183, name='pz_CR22_UCO_UPL')
pz_CR22_PLE_UPL = openmc.ZPlane( z0= 143.657, name='pz_CR22_PLE_UPL')
pz_CR22_ABS_UPL = openmc.ZPlane( z0= 140.544, name='pz_CR22_ABS_UPL')
pz_CR22_ABS_WRA = openmc.ZPlane( z0= 130.839, name='pz_CR22_ABS_WRA')
pz_CR22_LCO_WRA = openmc.ZPlane( z0=  89.494, name='pz_CR22_LCO_WRA')
pz_CR22_BAF_WRA = openmc.ZPlane( z0=  86.080, name='pz_CR22_BAF_WRA')
pz_CR22_BOT_WRA = openmc.ZPlane( z0=  81.863, name='pz_CR22_BOT_WRA')
...
# a_OU   - a_OU                                 | 515  
# a_VO   - a_VO  - Na Void Assembly             | 0    
# a_MU   - a_MU  - Mock-up Assembly             | 7    
# 
l_core.universes = \
       [ 
         [a_OU]*102,
         ...
         [a_FU]*3 +[a_MU]*2+[a_R2]   +[a_FU]*8 +[a_MU]  +[a_R2]   +[a_MU]*2+[a_FU]*7 +[a_R2]   +[a_MU]*2+[a_FU]*2 ,
...
settings_file.batches   = 550   # sum of active & inactive cycles
